function [model] = rpcaModelNEW(Xt, Xv, aG, varargin)
...
%factor.
    model = wPcaModelNEW(Xt, model.eta, model.kSelect, model.kSelectType, 'cpvThresh',model.cpvThresh);
    model.aT = aT;
    model.aE = aE;
    model.aG = aG;
    %%%%%
