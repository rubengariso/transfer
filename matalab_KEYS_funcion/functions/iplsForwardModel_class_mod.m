function [model] = iplsForwardModel_class_mod(X, Y, rndIndex,nInter,intervalIndex)
% 14.04.2023
...
for i=1:nInter,
   ...
   inModel_tent=intervalIndex==i;
    ...
    [ model_tent, HR_tent, HR_weigted_tent ] = plsModel_class(X(:,inModel_tent) ,Y, rndIndex);
